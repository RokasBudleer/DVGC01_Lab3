...
testcolon :- testread(['cmreader.txt', 'testcolon.pas']).
...
match(L, Tok) :- L = 'program',   Tok is 256.
match(L, Tok) :- L = 'input',     Tok is 257.
match(L, Tok) :- L = 'output',    Tok is 258.
match(L, Tok) :- L = 'var',       Tok is 259.
match(L, Tok) :- L = 'integer',   Tok is 260.
match(L, Tok) :- L = 'begin',     Tok is 261.
match(L, Tok) :- L = 'end',       Tok is 262.
match(L, Tok) :- L = 'boolean',   Tok is 263.
match(L, Tok) :- L = 'real',      Tok is 264.
match(L, Tok) :- L = ':=',        Tok is 271.
match(L, Tok) :- L = '(',         Tok is 40.
match(L, Tok) :- L = ')',         Tok is 41.
match(L, Tok) :- L = '*',         Tok is 42.
match(L, Tok) :- L = '+',         Tok is 43.
match(L, Tok) :- L = ',',         Tok is 44.
match(L, Tok) :- L = '.',         Tok is 46.
match(L, Tok) :- L = ':',         Tok is 58.
match(L, Tok) :- L = ';',         Tok is 59.

match(L, Tok) :- name(L, [H|T]), char_type(H, alpha), match_id(T), Tok is 270.
match(L, Tok) :- name(L, [H|T]), char_type(H, digit), match_num(T), Tok is 272.
match(L, Tok) :- char_type(L, end_of_file),   Tok is 275.
match(L, Tok) :- char_type(L, ascii),         Tok is 273.
...
parseall :- parseFiles([   'testfiles/testok1.pas',  'testfiles/testok2.pas',    'testfiles/testok3.pas',    'testfiles/testok4.pas', 
                          'testfiles/testok5.pas',  'testfiles/testok6.pas',    'testfiles/testok7.pas', 
                          'testfiles/testa.pas',    'testfiles/testb.pas',      'testfiles/testc.pas',      'testfiles/testd.pas',  'testfiles/teste.pas',  'testfiles/testf.pas',
...
parseokfiles :- parseFiles(['testfiles/testok1.pas',  'testfiles/testok2.pas',    'testfiles/testok3.pas',    'testfiles/testok4.pas', 
                            'testfiles/testok5.pas',  'testfiles/testok6.pas',    'testfiles/testok7.pas']).

parseazfiles :- parseFiles(['testfiles/testa.pas',    'testfiles/testb.pas',      'testfiles/testc.pas',      'testfiles/testd.pas',  'testfiles/teste.pas',  'testfiles/testf.pas',
                            'testfiles/testg.pas',    'testfiles/testh.pas',      'testfiles/testi.pas',      'testfiles/testj.pas',  'testfiles/testk.pas',
                            'testfiles/testl.pas',    'testfiles/testm.pas',      'testfiles/testn.pas',      'testfiles/testo.pas',  'testfiles/testp.pas',
                            'testfiles/testq.pas',    'testfiles/testr.pas',      'testfiles/tests.pas',      'testfiles/testt.pas',  'testfiles/testu.pas',
                            'testfiles/testv.pas',    'testfiles/testw.pas',      'testfiles/testx.pas',      'testfiles/testy.pas',  'testfiles/testz.pas']).                        

parsefunfiles :- parseFiles(['testfiles/fun1.pas',     'testfiles/fun2.pas',       'testfiles/fun3.pas',       'testfiles/fun4.pas',   'testfiles/fun5.pas']).
parsesemfiles :- parseFiles(['testfiles/sem1.pas',     'testfiles/sem2.pas',       'testfiles/sem3.pas',       'testfiles/sem4.pas',   'testfiles/sem5.pas']).

testall :- tell('parser.out'), write('Testing OK programs '),
    nl, 
    nl, parseokfiles,
    nl, write('Testing a-z programs '),
    nl,
    nl, parseazfiles, 
    nl,
    nl, write('Testing fun programs '),
    nl,
    nl, parsefunfiles,
    nl,
    nl, write('Testing sem programs '),
    nl,
